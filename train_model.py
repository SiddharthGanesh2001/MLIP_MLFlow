...
# Set experiment name
email = "sgane33@uic.edu"  # TODO: Use a customized experiment name
...
with mlflow.start_run(run_name=run_name):
    ...
    model_info = mlflow.sklearn.log_model(
        ...
        artifact_path="sid",  # TODO: Set the artifact path appropriately as a string
        signature=signature,
        input_example=X_train,
        registered_model_name="Boom",  # Optional TODO: Replace with a static name if needed - you will need to use the same static name when updating to a newer version of the model
    )
